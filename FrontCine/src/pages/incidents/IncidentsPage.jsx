      ...
      <Modal open={!!detail} onClose={() => setDetail(null)} title={detail?.id || 'Detalle'} size="md">
        {detail && (
          <div className={styles.detail}>
            ...
            {detail.description && <div className={styles.description}><p className={styles.detailLbl} style={{ marginBottom: 6 }}>Descripción</p><p style={{ fontSize: 12, color: 'var(--text-2)', lineHeight: 1.6 }}>{detail.description}</p></div>}
          </div>
        )}
      </Modal>
    </div>
