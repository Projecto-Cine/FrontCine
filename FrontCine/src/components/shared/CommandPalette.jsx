...
const COMMANDS = [
  ...
  { label: 'Taquilla',               icon: TicketCheck,     to: '/taquilla',    section: 'Punto de venta' },
  { label: 'Caja / Concesión',       icon: ShoppingCart,    to: '/caja',        section: 'Punto de venta' },
  { label: 'Películas',              icon: Film,            to: '/peliculas',   section: 'Operaciones' },
  { label: 'Salas',                  icon: Building2,       to: '/salas',       section: 'Operaciones' },
  { label: 'Horarios',               icon: CalendarDays,    to: '/horarios',    section: 'Operaciones' },
  { label: 'Reservas',               icon: Ticket,          to: '/reservas',    section: 'Operaciones' },
  { label: 'Incidencias',            icon: AlertTriangle,   to: '/incidencias', section: 'Gestión' },
  { label: 'Inventario',             icon: Package,         to: '/inventario',  section: 'Gestión' },
  { label: 'Informes',               icon: BarChart2,       to: '/informes',    section: 'Gestión' },
  { label: 'Cuadrante de Turnos',    icon: ClipboardList,   to: '/cuadrante',   section: 'Gestión' },
  { label: 'Trabajadores',           icon: Users,           to: '/usuarios',    section: 'Administración' },
  { label: 'Auditoría y Seguridad',  icon: ShieldCheck,     to: '/auditoria',   section: 'Administración' },
];
