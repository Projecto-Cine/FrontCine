              ...
              <div className={styles.managerBody}>
                ...
                <div className={styles.managerFormGrid}>
                  ...
                  <div>
                    ...
                    <input className={styles.managerInput} type="number" min="0" value={productForm.stock} onChange={e => setField('stock', e.target.value)} placeholder={t('concession.form.noLimit')} />
                  </div>
                  <div>
